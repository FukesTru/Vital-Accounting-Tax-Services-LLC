/**
 * TaxResolution.tsx — Vital Accounting & Tax Services LLC
 * Service page: Tax Resolution
...
const HERO_BG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663303940668/HR4QEbSY8a9WeoViWm5HgH/vital-tax-desk-e5TVkRLDrqKuWmnAjzQGZv.webp";
  ...
  return (
    <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} style={{ display: "flex", flexDirection: "column", gap: "1.125rem" }}>
      ...
      <div><label style={labelStyle}>Briefly describe your tax situation</label>
        <textarea rows={3} placeholder="e.g., IRS notice, back taxes owed, unfiled returns..." value={form.situation} onChange={(e) => setForm({ ...form, situation: e.target.value })}
          style={{ ...inputStyle, resize: "vertical", minHeight: "80px" }}
          onFocus={(e) => { e.currentTarget.style.borderColor = "#52B788"; }} onBlur={(e) => { e.currentTarget.style.borderColor = "rgba(255,255,255,0.2)"; }} /></div>
      <div>
        <label style={labelStyle}>Does your federal tax obligation exceed $50,000?</label>
        <p style={{ fontSize: "0.75rem", color: "rgba(255,255,255,0.5)", marginBottom: "0.5rem", lineHeight: 1.5 }}>If not, please do not request an appointment. This firm is structured specifically for significant tax obligations.</p>
        <select required value={form.qualifies} onChange={(e) => setForm({ ...form, qualifies: e.target.value })} style={{ ...inputStyle, cursor: "pointer" }}>
          ...
          <option value="yes-obligation">Yes, I owe $50,000+ in federal taxes</option>
          <option value="yes-income">My annual income exceeds $350,000</option>
          <option value="no">No, my obligation is below $50,000</option>
        </select>
      </div>
...
const whatItems = [
  ["IRS Notice Review and Response", "The firm reviews IRS correspondence, identifies the nature of the issue, and helps you understand what the notice means and what response is required."],
  ["Back Tax Obligation Analysis", "A structured review of outstanding federal and state tax obligations, including penalties and interest, to establish a clear picture of what is owed."],
  ["Unfiled Return Assessment", "For clients with unfiled prior-year returns, the firm reviews the situation and helps determine the appropriate path forward to bring your filing history current."],
  ["Payment Plan Structuring", "When a lump-sum payment is not feasible, the firm helps structure an installment arrangement with the IRS that is appropriate for your financial situation."],
  ["Penalty Abatement Review", "In certain circumstances, penalties can be reduced or removed. The firm reviews your situation to determine whether a penalty abatement request is appropriate."],
  ["Ongoing Compliance Support", "Once a resolution path is established, the firm provides ongoing support to ensure you remain compliant and avoid the same issues in future years."],
];

const faqs = [
  ["What qualifies as a significant tax obligation?", "This service is designed for taxpayers who owe $50,000 or more in federal taxes. If your obligation is below that threshold, please consult a general tax professional."],
  ["Can you guarantee a specific resolution outcome?", "No. The firm does not make guarantees about tax outcomes. Every situation is different, and the IRS makes its own determinations. The firm provides structured, professional guidance — not promises."],
  ["How long does tax resolution typically take?", "It depends on the complexity of the situation. Some matters are resolved in weeks; others take several months. The firm will give you an honest assessment of your specific situation during the consultation."],
      ...
      <section style={{ position: "relative", minHeight: "65vh", display: "flex", alignItems: "center", overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, paddingTop: "120px", paddingBottom: "80px" }}>
          <div style={{ maxWidth: "680px", opacity: heroVisible ? 1 : 0, transform: heroVisible ? "translateY(0)" : "translateY(24px)", transition: "opacity 900ms cubic-bezier(0.23,1,0.32,1), transform 900ms cubic-bezier(0.23,1,0.32,1)" }}>
            <span style={{ display: "block", fontFamily: "'Inter', sans-serif", fontSize: "0.6875rem", fontWeight: 600, letterSpacing: "0.2em", textTransform: "uppercase", color: "#52B788", marginBottom: "1.25rem" }}>Tax Resolution — Vital Accounting &amp; Tax Services LLC</span>
            <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(2.25rem, 5vw, 3.75rem)", fontWeight: 700, color: "#FFFFFF", lineHeight: 1.1, letterSpacing: "-0.02em", marginBottom: "1.5rem" }}>Structured Guidance for Taxpayers Facing Significant Federal Tax Obligations</h1>
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: "clamp(1rem, 1.5vw, 1.125rem)", color: "rgba(255,255,255,0.82)", lineHeight: 1.75, marginBottom: "2.25rem", maxWidth: "560px" }}>When you owe $50,000 or more in federal taxes, the situation requires a professional who understands the complexity of the IRS process and can help you navigate it with clarity.</p>
      ...
      <section style={{ backgroundColor: "#FFFFFF", padding: "6rem 0" }}>
        <div className="container">
          <div ref={introReveal.ref} style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center", opacity: introReveal.visible ? 1 : 0, transform: introReveal.visible ? "translateY(0)" : "translateY(32px)", transition: "opacity 800ms cubic-bezier(0.23,1,0.32,1) 100ms, transform 800ms cubic-bezier(0.23,1,0.32,1) 100ms" }} className="responsive-grid-2">
            <div>
              <span style={{ display: "block", fontFamily: "'Inter', sans-serif", fontSize: "0.6875rem", fontWeight: 600, letterSpacing: "0.15em", textTransform: "uppercase", color: "#1B4332", marginBottom: "0.75rem" }}>Tax Resolution</span>
              <span style={{ display: "block", width: "40px", height: "2px", backgroundColor: "#1B4332", marginBottom: "1.5rem" }} />
              <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1.875rem, 3vw, 2.75rem)", fontWeight: 700, color: "#111827", lineHeight: 1.15, marginBottom: "1.5rem" }}>When the IRS Is Involved, You Need a Structured Approach</h2>
              <p style={{ fontSize: "1.0625rem", color: "#374151", lineHeight: 1.8, marginBottom: "1.25rem" }}>A significant federal tax obligation does not resolve itself. Whether you have received an IRS notice, have unfiled returns, or owe back taxes with accumulating penalties and interest, the situation requires a clear, organized response — not avoidance.</p>
              <p style={{ fontSize: "1.0625rem", color: "#374151", lineHeight: 1.8, marginBottom: "2rem" }}>Vital Accounting &amp; Tax Services LLC works with taxpayers who owe $50,000 or more in federal taxes to bring structure and clarity to their situation. The firm does not make guarantees about outcomes, but it does provide honest, professional guidance through every step of the process.</p>
            ...
            <div style={{ borderRadius: "4px", overflow: "hidden", boxShadow: "0 24px 64px rgba(27,67,50,0.18), 0 8px 24px rgba(0,0,0,0.1)", transform: "perspective(1000px) rotateY(-2deg) rotateX(1deg)", transition: "transform 400ms ease, box-shadow 400ms ease" }}
              ...
              <img src={SIDE_IMG} alt="Tax resolution guidance" style={{ width: "100%", height: "420px", objectFit: "cover", display: "block" }} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div ref={whatReveal.ref} style={{ opacity: whatReveal.visible ? 1 : 0, transform: whatReveal.visible ? "translateY(0)" : "translateY(32px)", transition: "opacity 800ms cubic-bezier(0.23,1,0.32,1), transform 800ms cubic-bezier(0.23,1,0.32,1)" }}>
            <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
              ...
              <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(2rem, 3.5vw, 2.75rem)", fontWeight: 700, color: "#111827", lineHeight: 1.15, maxWidth: "600px", margin: "0 auto" }}>What Tax Resolution Support Includes</h2>
            </div>
